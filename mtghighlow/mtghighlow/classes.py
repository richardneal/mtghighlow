...
class Streak:
    def __init__(self, allcards = None, streak = None, beststreak = None, q = None):
        ...
        if q:
            ...
            for i in range(self.maxlength):
                ...
                self.q.append(Card(cardname=card[0], cardsetfull=card[1], cardset=card[2], realprice=card[3]))
    ...
    def new_card(self, choice = None):
        ...
        bottomcard = Card(cardname=bottom[0], cardsetfull=bottom[1], cardset=bottom[2], realprice=bottom[3])
...
class Card:
    def __init__(self, cardset = None, cardsetfull = None, cardname = None, realprice = 0, fakeprice = 0, image = None):
